# Generated by Django 3.2.11 on 2022-08-19 12:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('BP', '0199_alter_hipaadoc_watermark'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('thread', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chatmessage_thread', to='BP.thread')),
